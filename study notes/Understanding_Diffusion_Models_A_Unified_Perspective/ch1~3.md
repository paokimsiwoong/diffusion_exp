...
# [*Generative Models*](../../README.md#table-of-contents)
---
---
...
# [*Background*](../../README.md#table-of-contents)
---
---
...
# [*ELBO*](../../README.md#table-of-contents)
---
---
...
여기서 log evidence가 $`\phi`$와 무관하므로( $`p(x)`$는 $`p(x,z)`$에서 모든 $`z`$를 주변화(marginalize)해서 제거한 상태 ) $`\phi`$에 대해 상수취급이 가능
